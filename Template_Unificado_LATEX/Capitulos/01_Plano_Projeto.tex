...
A \autoref{fig:proj_gantt} apresenta a distribuição temporal das frentes de trabalho, dependências de precedência e o caminho crítico (CPM) modelados no StarUML v7.0.

% PLACEHOLDER STARUML v7.0: Diagrama de Gantt e Cronograma de Atividades
% Ferramenta: StarUML v7.0 -> Model -> Add Diagram -> Activity Diagram (com Raias/Swimlanes)
% Arquivo: Imagens/proj_gantt_cronograma.png (Exportar em PNG 300 DPI ou PDF vetorial)
% Descomente a linha abaixo apos salvar o arquivo no diretorio Imagens/:
% \incluirdiagrama{Imagens/proj_gantt_cronograma.png}{Diagrama de Gantt e Cronograma de Atividades}{fig:proj_gantt}
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering\vspace{1cm}%
        \textbf{[Diagrama de Gantt e Cronograma de Atividades -- StarUML v7.0]}\\%
        \textit{Modelar no StarUML v7.0 e exportar para: \texttt{Imagens/proj\_gantt\_cronograma.png}}\\%
        \small Menu: \texttt{File -> Export Diagram as -> PNG...} (Fundo branco, alta resolução 300 DPI)\\%
        \vspace{0.3cm}%
        \footnotesize Para ativar a imagem real, descomente no arquivo \texttt{.tex}:\\
        \texttt{\textbackslash incluirdiagrama\{Imagens/proj\_gantt\_cronograma.png\}\{Diagrama de Gantt e Cronograma de Atividades\}\{fig:proj_gantt\}}%
    \vspace{1cm}}}
    \caption{Diagrama de Gantt e Cronograma de Atividades do Projeto (Placeholder StarUML v7.0)}
